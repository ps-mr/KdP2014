...
nämlich @racket[(+ 21 21)] und @racket["(+ 21 21)"]. Der erste Ausdruck, @racket[42], ist ein Zahl; 
...
Wenn in BSL ein Laufzeitfehler auftritt, wird die Programmausführung abgebrochen und eine 
 ...
 zu der Funktion passt. Im Programm @racket[ (string-length "asdf" "fdsa")] tritt dieser Fehler auf.
